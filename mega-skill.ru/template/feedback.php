...
<form id="form">
      <div class="personality">
        ...
        <input id="sity" type="text" name="sity" required placeholder="Ваш город (для поиска работы в вашем городе)">
        <input id="skill" type="text" name="skill" required placeholder="опыт работы (сколько лет в судостроении)">
        <input id="trip" type="text" name="trip" required placeholder="Готовность к командировкам (готов/не готов)">
        <input id="team" type="text" name="team" required placeholder="Опыт работы в коллективе (есть/нету)">
        <input id="group" type="text" name="group" required placeholder="Своя бригада (колличество людей/нету)">
